...
import { FileText, TrendingUp, Clock, CheckCircle2, ShieldAlert, Check, X } from "lucide-react";
...
interface ManagerDashboardProps {
  ...
  handleApprove: (notificationId: string, quotationId: string) => Promise<void>;
  handleReject: (notificationId: string, quotationId: string, remarks: string) => Promise<void>;
  rejectionRemarks: Record<string, string>;
  setRejectionRemarks: React.Dispatch<React.SetStateAction<Record<string, string>>>;
}
              ...
              >
                ...
                <div className="flex items-center gap-2 shrink-0 md:self-center">
                  ...
                  <Button
                    ...
                    onClick={() => handleReject(notif.id, notif.quotationId, rejectionRemarks[notif.id])}

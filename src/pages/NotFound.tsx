...
const NotFound = ({ envMissing }: NotFoundProps) => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-tr from-primary/5 via-violet-500/5 to-transparent pointer-events-none" />
      ...
      <div className="text-center max-w-md w-full p-8 rounded-3xl border border-border/80 bg-card/70 backdrop-blur-md shadow-2xl relative z-10 animate-in fade-in zoom-in-95 duration-300">
        {envMissing ? (
          ...
          <>
            <h1 className="mb-2 text-7xl font-extrabold tracking-tighter bg-gradient-to-r from-primary via-violet-600 to-indigo-600 bg-clip-text text-transparent font-display">404</h1>
            ...
            <a href="/" className="inline-flex h-11 items-center justify-center rounded-xl bg-gradient-to-r from-primary to-violet-600 px-8 text-sm font-medium text-white shadow-lg shadow-primary/20 hover:from-primary/95 hover:to-violet-600/95 hover:shadow-primary/25 transition-all">
              Return to Home
            </a>
          </>
        )}
